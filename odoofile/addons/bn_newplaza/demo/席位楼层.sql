--select * from #temp2 where lngshopid=1000
...
drop table #temp_odoo_plan_ar
drop table #temp_odoo_plan_1
       ...
       FROM
         (
           ...
           where 1 = 1
                 ...
                 --and a.lngShopID = @lngShopID
                 --AND e.lngResourceType in(101,106,107,108)
                 and e.lngPlanTypeID = 1
                 and lngPeriod <> -1

                 --and DATEDIFF(day,@dtARDate,a.dtTrans )>=0
                 and a.dtTrans <= @dtARDate
                 and (

                   --a.lngShopID<> 1248 and  a.lngShopID<> 1029 and a.lngShopID<> 1332 and a.lngShopID<> 1109
         ...
         (
           ...
           where dtTrans <= @dtARDate
                 --AND h.lngResourceType in(101,106,107,108)
           ...
           --GROUP BY f.lngShopID,h.lngFloor
...
group by lngshopId, lngfloor, strplanid, strcontractid, strResourceType
